...
func NewContentInteractionResponse(content string) InteractionResponse {
	return InteractionResponse{Type: ChannelMessageWithSource, Data: InteractionApplicationCommandCallbackData{Content: content}}
}
